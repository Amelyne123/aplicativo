...
from kivy.uix.boxlayout import Button
...
class MinhaApp(App):
    def build(self):
        ...
        btn2 = Button(text="Clique Aqui!", halinh="center")
        ...
        info_label = Label(text="Pressione os botões para ver deferentes propriedade em ação.")
